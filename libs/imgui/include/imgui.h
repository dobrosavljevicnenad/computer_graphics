...
enum ImGuiTableFlags_ {
	...
	1
	<< 17, // Disable headers' contribution to automatic width calculation.
	...
	1
	<< 25, // Enable horizontal scrolling. Require 'outer_size' parameter of
...
enum ImGuiTableBgTarget_ {
    ...
    // Todo. Set column background color 1 (generally used for selection
    // marking)
