...
struct IMGUI_API ImDrawListSharedData {
    ...
    ImVec2 ArcFastVtx
	[12 *
	 IM_DRAWLIST_ARCFAST_TESSELLATION_MULTIPLIER]; // FIXME: Bake rounded
...
struct ImGuiTable {
    ...
    float RefScale; // Reference scale to be able to rescale columns on font/dpi
		    // changes.
    ImRect
	OuterRect; // Note: OuterRect.Max.y is often FLT_MAX until EndTable(),
    ...
    ImGuiTableColumnIdx
	AutoFitSingleStretchColumn; // Index of single stretch column requesting
				    // auto-fit.
